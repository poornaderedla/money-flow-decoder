...
const questions: Question[] = [
  ...
  { id: 25, text: "How often do you actively track your income and expenses?", type: "multiple", options: ["Daily", "Weekly", "Monthly", "Rarely", "Never"] },
  { id: 26, text: "I am consistent with my budgeting habits", type: "likert" },
  { id: 27, text: "I procrastinate when it comes to financial tasks", type: "multiple", options: ["Always", "Often", "Sometimes", "Rarely", "Never"] },
  { id: 28, text: "I avoid checking my bank account or credit score", type: "multiple", options: ["Always", "Often", "Sometimes", "Rarely", "Never"] },
  ...
  { id: 30, text: "I actively seek financial advice or mentorship", type: "multiple", options: ["Regularly", "Occasionally", "Rarely", "Never", "I prefer learning alone"] },
  { id: 31, text: "How often do you set and review financial goals?", type: "multiple", options: ["Monthly", "Quarterly", "Yearly", "Rarely", "Never"] },
  { id: 32, text: "My money decisions are driven more by:", type: "multiple", options: ["Pure emotion", "Mostly emotion", "Balanced emotion/logic", "Mostly logic", "Pure logic"] },
  { id: 33, text: "I make impulse purchases frequently", type: "multiple", options: ["Very often", "Often", "Sometimes", "Rarely", "Never"] },
  { id: 34, text: "I have taken concrete steps to increase my income recently", type: "multiple", options: ["Multiple active steps", "A few steps", "One or two steps", "Thinking about it", "No steps taken"] },
  { id: 35, text: "I consistently follow through on my money plans", type: "likert" },
  { id: 36, text: "I focus more on spending than building assets", type: "multiple", options: ["Strongly agree", "Somewhat agree", "Neutral", "Somewhat disagree", "Strongly disagree"] },

  // Section 4: Current Situation Frequency (12 questions)
  { id: 37, text: "My monthly income is at least 2x my expenses", type: "multiple", options: ["Yes, significantly more", "Yes, about 2x", "Close to 2x", "No, but close", "No, far from it"] },
  { id: 38, text: "My current debt situation:", type: "multiple", options: ["Completely debt-free", "Actively paying off debt", "Managing debt well", "Struggling with debt", "Overwhelmed by debt"] },
  { id: 39, text: "I save a consistent percentage of my income", type: "multiple", options: ["Yes, 20% or more", "Yes, 10-19%", "Yes, 5-9%", "Yes, under 5%", "No, inconsistent"] },
  { id: 40, text: "I have multiple streams of income", type: "multiple", options: ["Yes, several active streams", "Yes, 2-3 streams", "Yes, 1 additional stream", "Working on developing them", "No, single income source"] },
  { id: 41, text: "My current investing activity:", type: "multiple", options: ["Regular, diversified investing", "Occasional investing", "Just started investing", "Planning to start soon", "Not investing"] },
  { id: 42, text: "I own income-generating assets", type: "multiple", options: ["Yes, multiple assets", "Yes, one main asset", "Yes, small investments", "Planning to acquire", "No assets"] },
  { id: 43, text: "I have a written financial plan or roadmap", type: "multiple", options: ["Detailed written plan", "Basic written plan", "Mental plan only", "Rough ideas", "No plan"] },
  { id: 44, text: "I feel financially prepared for emergencies", type: "likert" },
  { id: 45, text: "I regularly provide financial support to others", type: "multiple", options: ["Yes, significant support", "Yes, moderate support", "Yes, occasional support", "Rarely", "Never"] },
  { id: 46, text: "I actively work on improving my money knowledge", type: "multiple", options: ["Constantly learning", "Regular learning", "Occasional learning", "Rarely", "Never"] },
  { id: 47, text: "I feel in complete control of my financial decisions", type: "likert" },
  { id: 48, text: "My current lifestyle aligns with my values and goals", type: "likert" }
];
